...
export default function Signup() {
    ...
    try {
      ...
      if (error) {
        setError(error.message)
            } else if (data.session) {        // User is automatically signed in        router.push('/')      } else if (data.user && !data.session) {
  ...
  return (
    <>
      <Head>
        <title>Sign Up - WrapeR2</title>
        <meta name="description" content="Create your WrapeR2 account" />
      </Head>
